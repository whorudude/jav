...
public class Main {
    public static void main(String[] args) {
        List<Animal> animale = Animal.citesteFisier("src/main/resources/animale.csv");
        ...
        if(animale.getFirst().getInaltime()==inaltime)
        {
        ...
        pisici.add(new Pisica("Alta Pisica",6,LocalDate.of(2024,7,6),9,"maidaneza"));
